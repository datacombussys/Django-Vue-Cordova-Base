<template>
  <f7-app :params="f7params">
    ...
    <f7-panel left cover theme-dark :visible-breakpoint="960">
      <f7-view>
        <f7-page>
          <f7-navbar title="Profile Image"></f7-navbar>
          <f7-block-title medium>Navigation</f7-block-title>
          <f7-list>
            ...
            <f7-list-item link="/users/" view=".view-main" panel-close title="Form and table"></f7-list-item>
